 ...
 *  
 *  Changes: 
 *   - Added Global jQuery Ajax cache option to disable caching
 *   - Changed var getFolderInfo to $.getFolderInfo, needed it to make it accessable from a popup window
 *   - Changed cleanstring, "-" is also allowed in filenames
 */
...
(function ($) {
    ...
    var capabilities = new Array('select', 'download', 'rename', 'delete', 'edit');
    ...
    var cleanString = function (str) {
        ...
        cleaned = cleaned.replace(/[^_a-zA-Z0-9\-]/g, ""); // added: also allowed "-"
    ...
    var getFileInfo = function (file) {
        ...
        if (browseOnly != true) template += '<button id="edit" name="edit" type="button" value="Edit">' + lg.edit + '</button>';
    ...
    var editImage = function (data) {
        ...
        if (isImage) {
            ...
            // open popup
            window.open("plugins/image-editor/index.html?path=" + data['Path'],
